...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button color='secondary' onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                        <Button color="error" onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="small" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions style={{justifyContent: 'flex-end', paddingRight: '15px'}}>
            <Button style={{padding: '5px 30px'}} color="secondary" size="small" variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
            <Button style={{padding: '5px 30px'}} color="secondary" size="small" variant="outlined">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
